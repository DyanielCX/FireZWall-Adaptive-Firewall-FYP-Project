// ====================================================
// Add Common Service Port Endpoint Content Component
// Location: /src/pages/APIDocs/AddServicePortDoc.jsx
// ====================================================

const AddServicePortEndpointContent = ({ activeTab, setActiveTab }) => (
    ...
    <p className="text-slate-400 text-lg">
        Add a new common service port for the service parameter of add and delete firewall endpoint.
    </p>
    ...
    <div className="overflow-x-auto">
        ...
        <tbody>
            <tr className="border-b border-slate-700/50">
                ...
                <td className="py-3 px-4 text-slate-400">The network port number for the common service port</td>
            </tr>
            <tr className="border-b border-slate-700/50">
...
export default AddServicePortEndpointContent;