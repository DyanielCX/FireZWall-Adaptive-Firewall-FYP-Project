// ==================================================
// View Firewall Rule Endpoint Content Component
// Location: /src/pages/APIDocs/ViewFirewallDoc.jsx
// ==================================================

const ViewFirewallEndpointContent = ({ activeTab, setActiveTab }) => (
      ...
      <div className="bg-slate-800/50 rounded-lg p-8 border border-slate-700/50">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <code className="text-2xl font-bold text-white">/api/firewall/status</code>
          </div>
        </div>
    
        <p className="text-slate-400 text-lg">
            Retrieve a list of all current existed firewall rules.
        </p>
...
endpoint = "https://<server_ip>:5000/api/firewall/status"
...
print(r.json())`}
        ...
        <pre className="bg-slate-900/50 text-slate-300 p-4 rounded-lg overflow-x-auto">
{`const response = await fetch('https://<server_ip>:5000/api/firewall/status', {
    method: 'GET',
    headers: {
        'Authorization': 'Bearer <access_token>'
    }
...
console.log(data);`}
        ...
        {activeTab === 'shell' && (
        <pre className="bg-slate-900/50 text-slate-300 p-4 rounded-lg overflow-x-auto">
{`curl -X get https://<server_ip>:5000/api/firewall/status \\
...
export default ViewFirewallEndpointContent;