// ==================================================
// Logout All Devices Endpoint Content Component
// Location: /src/pages/APIDocs/LogoutAllDoc.jsx
// ==================================================

const LogoutAllEndpointContent = ({ activeTab, setActiveTab }) => (
    <div className="space-y-6">
      ...
      <div className="bg-slate-800/50 rounded-lg p-8 border border-slate-700/50">
        <div className="flex items-center gap-3 mb-4">
          ...
          <code className="text-2xl font-bold text-white">/api/logout-all</code>
        </div>
        <p className="text-slate-400 text-lg">
          Logout all devices and revoke all access tokens & refresh tokens.
        </p>
      </div>
...
endpoint = "https://<server_ip>:5000/api/logout-all"
...
print(r.json())`}
          ...
          {activeTab === 'javascript' && (
            <pre className="bg-slate-900/50 text-slate-300 p-4 rounded-lg overflow-x-auto">
{`const response = await fetch('https://<server_ip>:5000/api/logout-all', {
  method: 'POST',
  headers: {
      'Content-Type': 'application/json',
      'Authorization': 'Bearer <token>'
...
console.log(data);`}
          ...
          {activeTab === 'shell' && (
            <pre className="bg-slate-900/50 text-slate-300 p-4 rounded-lg overflow-x-auto">
  {`curl -X POST https://<server_ip>:5000/api/logout-all \\
...
export default LogoutAllEndpointContent;