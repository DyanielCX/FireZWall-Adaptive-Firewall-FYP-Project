// =======================================================
// Delete Common Service Port Endpoint Content Component
// Location: /src/pages/APIDocs/DeleteServicePortDoc.jsx
// =======================================================

const DeleteServicePortEndpointContent = ({ activeTab, setActiveTab }) => (
    ...
    <p className="text-slate-400 text-lg">
        Delete the common service port that is used for the service parameter of add and delete firewall endpoint.
    </p>
        ...
        <tbody>
            <tr className="border-b border-slate-700/50">
                ...
                <td className="py-3 px-4">
                    <div className="space-y-1">
                        ...
                        The network port number of the common service port to delete
                        </div>
            ...
            <tr className="border-b border-slate-700/50">
                ...
                <td className="py-3 px-4">
                    <div className="space-y-1">
                        <div className="text-slate-400">
                        The service name associated with the deleted common service port
                        </div>
                        <div className="text-red-500 text-sm">
...
console.log(data);`}
        ...
        {activeTab === 'shell' && (
        <pre className="bg-slate-900/50 text-slate-300 p-4 rounded-lg overflow-x-auto">
{`curl -X DELETE https://<server_ip>:5000/api/firewall/svc-port \\
...
export default DeleteServicePortEndpointContent;