// ==================================================
// Delete Firewall Rule Endpoint Content Component
// Location: /src/pages/APIDocs/DeleteFirewallDoc.jsx
// ==================================================

const DeleteFirewallEndpointContent = ({ activeTab, setActiveTab }) => (
    ...
    <p className="text-slate-400 text-lg">
        Delete the existed firewall rule with API request.
    </p>
        ...
        <tbody>
            <tr className="border-b border-slate-700/50">
                ...
                <td className="py-3 px-4">
                    <div className="space-y-1">
                        ...
                        Specifies the firewall rule action to delete
            ...
            <tr className="border-b border-slate-700/50">
                ...
                <td className="py-3 px-4">
                    <div className="space-y-1">
                        <div className="text-slate-400">
                        The network port number of the firewall rule to delete
            ...
            <tr className="border-b border-slate-700/50">
                ...
                <td className="py-3 px-4">
                    <div className="space-y-1">
                        <div className="text-slate-400">
                        The service name associated with the deleted firewall rule
                        </div>
                        <div className="text-red-500 text-sm">
            ...
            <tr className="border-b border-slate-700/50">
                ...
                <td className="py-3 px-4">
                    <div className="space-y-1">
                        <div className="text-slate-400">
                        The network protocol associated with the deleted firewall rule
            ...
            <tr className="border-b border-slate-700/50">
                ...
                <td className="py-3 px-4">
                    <div className="space-y-1">
                        <div className="text-slate-400">
                        Specifies the traffic direction of the firewall rule to delete
            ...
            <tr className="border-b border-slate-700/50">
                ...
                <div className="space-y-1">
                        <div className="text-slate-400">
                        Indicates whether delete the rule that is applies to IPv4 traffic
                        </div>
                        <div className="text-slate-500 text-sm">
            ...
            <tr className="border-b border-slate-700/50">
                ...
                <div className="space-y-1">
                        <div className="text-slate-400">
                        Indicates whether delete the rule that is applies to IPv6 traffic
                        </div>
                        <div className="text-slate-500 text-sm">
                            Default: <code className="text-orange-400 bg-orange-500/10 px-1.5 py-0.5 rounded">True</code>
                        </div>
            ...
            <tr className="border-b border-slate-700/50">
                ...
                <div className="space-y-1">
                        <div className="text-slate-400">
                        Specifies the source IP address or subnet of the deleted firewall rule
                        </div>
...
console.log(data);`}
        ...
        {activeTab === 'shell' && (
        <pre className="bg-slate-900/50 text-slate-300 p-4 rounded-lg overflow-x-auto">
{`curl -X DELETE https://<server_ip>:5000/api/firewall \\
...
export default DeleteFirewallEndpointContent;