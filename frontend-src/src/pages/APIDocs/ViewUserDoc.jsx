// ==================================================
// View User Endpoint Content Component
// Location: /src/pages/APIDocs/ViewUserDoc.jsx
// ==================================================

const ViewUsersEndpointContent = ({ activeTab, setActiveTab }) => (
      ...
      <div className="bg-slate-800/50 rounded-lg p-8 border border-slate-700/50">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <code className="text-2xl font-bold text-white">/api/user/view</code>
          </div>
    </div>
        ...
        <tbody>
            <tr className="border-b border-slate-700/50">
                ...
                <td className="py-3 px-4 text-slate-400">
                    Filter users by role. If not provided, returns all users
...
endpoint = "https://<server_ip>:5000/api/user/view"
...
print(r.json())`}
        ...
        <pre className="bg-slate-900/50 text-slate-300 p-4 rounded-lg overflow-x-auto">
{`const response = await fetch('https://<server_ip>:5000/api/user/view', {
    method: 'POST',
    headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer <access_token>'  // Must be admin token
...
console.log(data);`}
        ...
        {activeTab === 'shell' && (
        <pre className="bg-slate-900/50 text-slate-300 p-4 rounded-lg overflow-x-auto">
{`curl -X POST https://<server_ip>:5000/api/user/view \\
...
export default ViewUsersEndpointContent;